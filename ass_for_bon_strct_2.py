...
rs.AddCurve((scaledSquarePoints[0], originPoint, scaledSquarePoints[1]))
rs.AddCurve((scaledSquarePoints[3], originPoint, scaledSquarePoints[2]))

#for the triangles around the center square
triangleOne = rs.AddCurve((circlePoints[2], scaledSquarePoints[0], scaledSquarePoints[3], circlePoints[2]))
...
triangleTwo = rs.AddCurve((circlePoints[4], scaledSquarePoints[0], scaledSquarePoints[1], circlePoints[4]))
...
triangleThree = rs.AddCurve((circlePoints[6], scaledSquarePoints[1], scaledSquarePoints[2], circlePoints[6]))
...
triangleFour = rs.AddCurve((circlePoints[0], scaledSquarePoints[3], scaledSquarePoints[2], circlePoints[0]))
